  ...
  <div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="col-md-9">
                <p>名字：</p>
                <input type="text" placeholder="请输入商品名称" v-model="item.goodsname">
            </div>
            <div class="col-md-9">
                <p>编号：</p>
                <input type="text" placeholder="请输入商品编号" v-model="item.goods_num">
            </div>
            <div class="col-md-9">
                <p>原价：</p>
                <input type="text" placeholder="请输入原价" v-model="item.original_price">
            </div>
            <div class="col-md-9">
                <p>折扣：</p>
                <input type="text" placeholder="请输入折扣" v-model="item.disc">
            </div>
          <!--<div class="col-md-9">-->
                <!--<p>折扣：</p>-->
          ...
          <div class="col-md-9">
            ...
            <!--<input type="text" placeholder="请输入邮箱" v-model="item.email">-->
            <div class="col-sm-3">
              <select class="form-control bk-valign-top" v-model="item.category">
          ...
          <div class="col-md-9">
            <p>颜色：</p>
            <input type="text" placeholder="请输入颜色" v-model="item.color">
          </div>
          <div class="col-md-9">
            <p>商品图片：</p>
            <el-upload
              ...
              :auto-upload="false">
              <!--:on-success=""-->
              <img v-if="imageUrl" :src="$site_url+imageUrl" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </div>
          <div class="col-md-9">
                <p>材质：</p>
                <input type="text" placeholder="请输入材质" v-model="item.material">
            </div>
          <div class="col-md-9">
                <p>规格：</p>
                <input type="text" placeholder="请输入规格" v-model="item.size">
            </div>
          <div class="col-md-9">
                <p>库存：</p>
...
export default {
    ...
    methods: {
      ...
      save() {
        var vm = this;
        vm.item.imageUrl = vm.imageUrl
        $.ajax({
            url: `${SITE_URL}goods/add_goods/`,
            dataType: 'json',
            type: 'POST',
            xhrFields: {
              withCredentials: true
